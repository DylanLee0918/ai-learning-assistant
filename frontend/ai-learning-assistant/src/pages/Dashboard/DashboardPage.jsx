    ...
    useEffect(() => {
        const fetchDashboardData = async () => {
            try {
                ...
                console.log("Data___getDashboardData", response);
                ...
                <div className="relative max-w-7xl mx-auto">
                    ...
                    <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-6">
                        <div className="flex items-center gap-3 mb-6">
                            <div className="w-10 h-10 rounded-xl bg-linear-to-br from-slate-100 to-slate-200 flex justify-center items-center ">
                            ...
                            <div className="space-y-3">
                                {[
                                    ...
                                    ...(dashboardData.recentActivity.quizzes || []).map((quiz) => ({
                                        ...
                                        timestamp:
                                            quiz.lastAccessed || quiz.createdAt || quiz.updatedAt,
                                    ...
                                    .map((activity, index) => (
                                        <div
                                            ...
                                            className="group flex justify-between items-center p-4 rounded-xl bg-slate-50/50 border border-slate-200/60 hover:bg-white hover:border-slate-300/60 hover:shadow-md transition-all duration-200"
                                        >
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center gap-2 mb-1">
                                                    <div
                                                        className={`w-2 h-2 rounded-full shrink-0 ${activity.type === "document" ? "bg-linear-to-r from-blue-400 to-cyan-500" : "bg-linear-to-r from-emerald-400 to-teal-500"}`}
                                                    />
